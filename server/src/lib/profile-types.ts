...
export function profileTypeToTemplateType(profileType: ProfileType): string {
  return profileType;
}

export function profileTypeToPrismaEnum(profileType: ProfileType): "ITEMS" | "PETS" | "BUSINESS" | "CREATOR" | "EVENT" {
  return profileType.toUpperCase() as "ITEMS" | "PETS" | "BUSINESS" | "CREATOR" | "EVENT";
}

export function prismaEnumToProfileType(value: string): ProfileType {
  return value.toLowerCase() as ProfileType;
}
